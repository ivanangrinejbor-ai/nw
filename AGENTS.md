...
Р‘С‹СЃС‚СЂС‹Р№ СЃС‚Р°СЂС‚: `./gradlew copyTemplateApk` РґР»СЏ РѕР±РЅРѕРІР»РµРЅРёСЏ APK-С‚РµРјРїР»РµР№С‚Р° (С‚РѕР»СЊРєРѕ РґР»СЏ СЂРµРіРµРЅРµСЂР°С†РёРё Рё РїР°Р±Р»РёРєР°С†РёРё РІ СЂРµРїРѕР·РёС‚РѕСЂРёР№ Neocatroid-Template; РїСЂРё СЃР±РѕСЂРєРµ APK-РёРіСЂ РёРіСЂС‹ V3 С€Р°Р±Р»РѕРЅ СЃРєР°С‡РёРІР°РµС‚СЃСЏ СЃ GitHub Рё РєСЌС€РёСЂСѓРµС‚СЃСЏ).
...
- **Р›РѕРєР°С‚РѕСЂ С€Р°Р±Р»РѕРЅР°**: catroid/.../apkbuildV3/TemplateManagerV3.kt вЂ” prepareBaseApk С‚РµРїРµСЂСЊ: 1) РєСЌС€ `filesDir/v3_template/template_runtime_v3.apk` (СЃРІРµР¶РµСЃС‚СЊ С‡РµСЂРµР· HEAD + ETag, С„Р°Р№Р» `.etag` СЂСЏРґРѕРј); 2) СЃРєР°С‡РёРІР°РЅРёРµ СЃ GitHub (`raw.githubusercontent.com/ivanangrinejbor-ai/Neocatroid-Template` в†’ LFS-РґРµС‚РµРєС‚ РїРѕ РїСЂРµС„РёРєСЃСѓ `version https://git-lfs.github.com/spec/v1` в†’ media.githubusercontent.com), OkHttp (connect 15s, read 300s, buffer 64КБ, С‚РµРєСѓС‰РёР№ РїСЂРѕРіСЂРµСЃСЃ РІ onProgress); 3) fallback assets (legacy); 4) fallback РЅР° СЃРѕР±СЃС‚РІРµРЅРЅС‹Р№ APK (applicationInfo.sourceDir); Р±СЂРѕСЃР°РµС‚ IllegalStateException СЃ РїСЂРёС‡РёРЅР°РјРё РѕС‚РєР°Р·Р° РІРјРµСЃС‚Рѕ null. РџСЂРѕРіСЂРµСЃСЃ СЃРєР°С‡РёРІР°РЅРёСЏ РјР°РїРїРёС‚СЃСЏ РІ 0..0.15f РѕРєРЅР° assemble (locateBaseApk РїРµСЂРµРґР°С‘С‚ p*0.15f). V3ApkAssembler.assemble РїСЂРѕР±СЂР°СЃС‹РІР°РµС‚ РёСЃРєР»СЋС‡РµРЅРёРµ, РїРѕСЌС‚РѕРјСѓ ApkBuilderV3Engine РїРѕРєР°Р·С‹РІР°РµС‚ СЂРµР°Р»СЊРЅСѓСЋ РїСЂРёС‡РёРЅСѓ, Р° РЅРµ РѕР±РѕР±С‰С‘РЅРЅРѕРµ В«РїСЂРѕРІРµСЂСЊС‚Рµ template_runtime.apkВ». РџР°Р№РїР»Р°Р№РЅ injectв†’patchв†’sign РїСЂРѕРІРµСЂРµРЅ headless РЅР° РѕР±РµРёС… Р±Р°Р·Р°С… (runtime-С€Р°Р±Р»РѕРЅ 188 РњР‘ Рё self-APK 624 РњР‘) вЂ” СЂР°Р±РѕС‚Р°РµС‚; Р·РЅР°С‡РёС‚ СЃР±РѕР№ РЅР° СѓСЃС‚СЂРѕР№СЃС‚РІРµ = prepareBaseApk РІРµСЂРЅСѓР» null (РЅРµС‚ С„Р°Р№Р»Р° РІ СѓСЃС‚Р°РЅРѕРІР»РµРЅРЅРѕРј APK, РЅРµ С…РІР°С‚Р°РµС‚ РјРµСЃС‚Р° РІ cacheDir Р»РёР±Рѕ РѕС„Р»Р°Р№РЅ Р±РµР· РєСЌС€Р°). `catroid/src/main/assets/template_runtime.apk` Р±РѕР»СЊС€Рµ РЅРµ Р»РµР¶РёС‚ РІ assets РёРіСЂС‹ V3 (РіРёС‚РёРіРЅРѕСЂРёСЂРѕРІР°РЅ, РіРёС‚ РЅРµ С‚СЂРµРєРёС‚) вЂ” РїСЂРё С‚РµСЃС‚Рµ V3PackageRenameTest.exportTwoGames_coexistAndVerify СЂРµРїР°Рє Р±РµСЂС‘С‚СЃСЏ РёР· src/main/assets/template_runtime.apk СЃ assumeTrue Рё СЂР°РІРЅРѕ СЃРєРёРїР°РµС‚СЃСЏ.
