...
public class PutFileIntoFolderBrickTest {
    ...
    @Test
    public void testPutFileIntoFolderBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        PutFileIntoFolderBrick brick = new PutFileIntoFolderBrick("source.txt", "myFolder");

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createPutFileIntoFolderAction(eq(sprite),
