...
import org.catrobat.catroid.content.actions.DeleteFirebaseFileAction;
...
public class DeleteFirebaseFileActionTest {
    ...
    public void testNullFormulasDoNotCrash() {
        DeleteFirebaseFileAction action = new DeleteFirebaseFileAction();
