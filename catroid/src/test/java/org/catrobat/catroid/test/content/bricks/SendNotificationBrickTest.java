...
public class SendNotificationBrickTest {
    ...
    @Test
    public void testSendNotificationBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        SendNotificationBrick brick = new SendNotificationBrick(1);

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createSendNotificationAction(eq(sprite),
