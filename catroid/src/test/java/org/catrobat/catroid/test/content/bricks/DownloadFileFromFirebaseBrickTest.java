...
public class DownloadFileFromFirebaseBrickTest {
    ...
    @Test
    public void testDownloadBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        DownloadFileFromFirebaseBrick brick =
                new DownloadFileFromFirebaseBrick("mybucket", "images/photo.jpg", "downloaded.png");
        brick.setUserVariable(new UserVariable("result"));

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createDownloadFileFromFirebaseAction(eq(sprite),
                any(SequenceAction.class), any(Formula.class), any(Formula.class),
                any(Formula.class), any(UserVariable.class));
    }
}
