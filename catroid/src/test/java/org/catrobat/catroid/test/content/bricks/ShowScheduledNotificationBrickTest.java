...
public class ShowScheduledNotificationBrickTest {
    ...
    @Test
    public void testShowScheduledNotificationBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        ShowScheduledNotificationBrick brick = new ShowScheduledNotificationBrick(1, 5);
