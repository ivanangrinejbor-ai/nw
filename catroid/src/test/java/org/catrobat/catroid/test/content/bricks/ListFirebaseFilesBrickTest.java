...
public class ListFirebaseFilesBrickTest {
    ...
    @Test
    public void testListBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        ListFirebaseFilesBrick brick = new ListFirebaseFilesBrick("mybucket", "images/");
        ...
        verify(actionFactory).createListFirebaseFilesAction(eq(sprite),
                any(SequenceAction.class), any(Formula.class), any(Formula.class), any(UserVariable.class));
    }
}
