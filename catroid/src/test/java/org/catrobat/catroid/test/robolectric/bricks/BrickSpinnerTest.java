	...
	public static Collection<Object[]> data() {
		return asList(new Object[][] {
				...
				{PostWebRequestBrick.class.getSimpleName(), new PostWebRequestBrick(),
						R.id.post_web_request_spinner, "someList", asList("new…", "someList")},
				{RunJSBrick.class.getSimpleName(), new RunJSBrick(),
						R.id.brick_run_js_spinner, "someList", asList("new…", "someList")},
				{AskGeminiBrick.class.getSimpleName(), new AskGeminiBrick(),
						R.id.brick_ask_gemini_spinner, "someList", asList("new…", "someList")},
