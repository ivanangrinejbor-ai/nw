...
public class UploadFileToFirebaseBrickTest {
    ...
    @Test
    public void testUploadBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        UploadFileToFirebaseBrick brick =
                new UploadFileToFirebaseBrick("mybucket", "images/photo.jpg", "screenshot.png");

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createUploadFileToFirebaseAction(eq(sprite),
