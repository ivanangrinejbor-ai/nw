...
public class DeleteCloneByNumberBrickTest {
    ...
    @Test
    public void testDeleteCloneByNumberBrickCreatesActionWithCorrectSprite() {
        ...
        verify(actionFactory).createDeleteCloneByNumberAction(eq(sprite),
