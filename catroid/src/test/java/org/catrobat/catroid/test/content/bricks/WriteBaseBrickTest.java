...
public class WriteBaseBrickTest {
    ...
    @Test
    public void testWriteBaseBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        WriteBaseBrick brick = new WriteBaseBrick("https://test.firebaseio.com", "myKey", "myValue");

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createWriteBaseAction(eq(sprite),
