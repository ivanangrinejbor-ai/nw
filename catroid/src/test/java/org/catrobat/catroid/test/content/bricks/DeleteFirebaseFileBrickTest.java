...
public class DeleteFirebaseFileBrickTest {
    ...
    @Test
    public void testDeleteBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        DeleteFirebaseFileBrick brick = new DeleteFirebaseFileBrick("mybucket", "images/old.jpg");

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createDeleteFirebaseFileAction(eq(sprite),
