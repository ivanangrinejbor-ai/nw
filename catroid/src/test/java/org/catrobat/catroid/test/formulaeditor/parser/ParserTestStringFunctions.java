...
public class ParserTestStringFunctions {
	...
	@Test
	public void testVar() {
		String letterString = "variable1";
		FormulaEditorTestUtil.testSingleParameterFunction(Functions.REVERSE,
				InternTokenType.STRING, letterString,
				"0", testScope);
	}
	...
	public void testReverse() {
		...
		FormulaEditorTestUtil.testSingleParameterFunction(Functions.REVERSE,
				InternTokenType.STRING, letterString,
				"dlrow olleh", testScope);

		letterString = "Should work";
		FormulaEditorTestUtil.testSingleParameterFunction(Functions.REVERSE,
				InternTokenType.STRING, letterString,
				"krow dluohS", testScope);

		letterString = "Should not work";
		FormulaEditorTestUtil.testSingleParameterFunction(Functions.REVERSE,
				InternTokenType.STRING, letterString,
				"krow ton dluohS", testScope);
		...
		List<InternToken> firstParameterList =
				FormulaEditorTestUtil.buildBinaryOperator(InternTokenType.NUMBER, "0",
						Operators.PLUS, InternTokenType.STRING, "Work");
		FormulaEditorTestUtil.testSingleParameterFunction(Functions.REVERSE, firstParameterList,
				"NaN", testScope);
	}
