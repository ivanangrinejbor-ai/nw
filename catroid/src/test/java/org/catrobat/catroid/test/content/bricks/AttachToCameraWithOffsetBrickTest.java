...
public class AttachToCameraWithOffsetBrickTest {
    ...
    @Test
    public void testAttachToCameraWithOffsetBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        AttachToCameraWithOffsetBrick brick = new AttachToCameraWithOffsetBrick("object1", 1.0f, 2.0f, 3.0f);

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createAttachToCameraWithOffsetAction(eq(sprite),
