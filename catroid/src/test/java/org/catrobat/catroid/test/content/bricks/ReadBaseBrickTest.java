...
public class ReadBaseBrickTest {
    ...
    @Test
    public void testReadBaseBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        ReadBaseBrick brick = new ReadBaseBrick("https://test.firebaseio.com", "myKey");
        ...
        verify(actionFactory).createReadBaseAction(eq(sprite),
