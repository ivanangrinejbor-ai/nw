...
public class DeleteBaseBrickTest {
    ...
    @Test
    public void testDeleteBaseBrickCreatesActionWithCorrectSprite() {
        ActionFactory actionFactory = Mockito.mock(ActionFactory.class);
        sprite.setActionFactory(actionFactory);
        DeleteBaseBrick brick = new DeleteBaseBrick("https://test.firebaseio.com", "myKey");

        brick.addActionToSequence(sprite, new ScriptSequenceAction(Mockito.mock(Script.class)));

        verify(actionFactory).createDeleteBaseAction(eq(sprite),
