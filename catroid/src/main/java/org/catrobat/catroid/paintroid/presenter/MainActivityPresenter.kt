 ...
 */
package org.catrobat.catroid.paintroid.presenter
...
import org.catrobat.catroid.paintroid.common.CREATE_FILE_DEFAULT
import org.catrobat.catroid.paintroid.common.LOAD_IMAGE_CATROID
import org.catrobat.catroid.paintroid.common.LOAD_IMAGE_DEFAULT
import org.catrobat.catroid.paintroid.common.LOAD_IMAGE_IMPORT_PNG
import org.catrobat.catroid.paintroid.common.MainActivityConstants.ActivityRequestCode
import org.catrobat.catroid.paintroid.common.MainActivityConstants.CreateFileRequestCode
import org.catrobat.catroid.paintroid.common.MainActivityConstants.LoadImageRequestCode
import org.catrobat.catroid.paintroid.common.MainActivityConstants.PermissionRequestCode
import org.catrobat.catroid.paintroid.common.MainActivityConstants.SaveImageRequestCode
import org.catrobat.catroid.paintroid.common.PERMISSION_EXTERNAL_STORAGE_SAVE
import org.catrobat.catroid.paintroid.common.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_FINISH
import org.catrobat.catroid.paintroid.common.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_LOAD_NEW
import org.catrobat.catroid.paintroid.common.PERMISSION_EXTERNAL_STORAGE_SAVE_CONFIRMED_NEW_EMPTY
import org.catrobat.catroid.paintroid.common.PERMISSION_EXTERNAL_STORAGE_SAVE_COPY
import org.catrobat.catroid.paintroid.common.PERMISSION_REQUEST_CODE_IMPORT_PICTURE
import org.catrobat.catroid.paintroid.common.PERMISSION_REQUEST_CODE_REPLACE_PICTURE
import org.catrobat.catroid.paintroid.common.REQUEST_CODE_IMPORT_PNG
import org.catrobat.catroid.paintroid.common.REQUEST_CODE_INTRO
import org.catrobat.catroid.paintroid.common.REQUEST_CODE_LOAD_PICTURE
import org.catrobat.catroid.paintroid.common.RESULT_INTRO_MW_NOT_SUPPORTED
import org.catrobat.catroid.paintroid.common.SAVE_IMAGE_DEFAULT
import org.catrobat.catroid.paintroid.common.SAVE_IMAGE_FINISH
import org.catrobat.catroid.paintroid.common.SAVE_IMAGE_LOAD_NEW
import org.catrobat.catroid.paintroid.common.SAVE_IMAGE_NEW_EMPTY
...
import org.catrobat.catroid.paintroid.contract.MainActivityContracts.MainView
import org.catrobat.catroid.paintroid.controller.ToolController
...
import org.catrobat.catroid.paintroid.tools.implementation.CLICK_TIMEOUT_MILLIS
import org.catrobat.catroid.paintroid.tools.implementation.CONSTANT_3
import org.catrobat.catroid.paintroid.tools.implementation.ClippingTool
...
open class MainActivityPresenter(
    ...
    private fun setTool(toolType: ToolType) {
        idlingResource.increment()
        bottomBarViewHolder.setSelectedTool(toolType)
        bottomBarViewHolder.hide()
    ...
    companion object {
        ...
        fun getPathFromUri(context: Context, uri: Uri): String {
            if (DocumentsContract.isDocumentUri(context, uri)) {
                if (isExternalStorageDocument(uri)) {
                    ...
                    val contentUri = if (id.startsWith("msf:") || id.contains(":")) {
                        val cleaned = id.split(":").lastOrNull() ?: id
        ...
        private fun getDataColumn(
            ...
            try {
                ...
                Log.e("MainActivityPresenter", "getDataColumn fallback", e)
                val file = File(context.cacheDir, TEMP_PICTURE_NAME)
                FileIO.saveFileFromUri(uri, file, context)
