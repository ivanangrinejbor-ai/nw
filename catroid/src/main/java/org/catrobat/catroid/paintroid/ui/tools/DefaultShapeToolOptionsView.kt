...
import org.catrobat.catroid.paintroid.tools.drawable.DrawableShape
import org.catrobat.catroid.paintroid.tools.drawable.DrawableStyle
import org.catrobat.catroid.paintroid.tools.helper.DefaultNumberRangeFilter
import org.catrobat.catroid.paintroid.tools.options.ShapeToolOptionsView
...
class DefaultShapeToolOptionsView(rootView: ViewGroup) : ShapeToolOptionsView {
    ...
    private val pixelButton: AppCompatImageButton
    ...
    init {
        ...
        shapeToolView.run {
            ...
            pixelButton = findViewById(R.id.pocketpaint_shapes_pixel_btn)
    ...
    private fun initializeListeners() {
        ...
        pixelButton.setOnClickListener { onShapeClicked(DrawableShape.PIXEL) }
    ...
    private fun resetShapeActivated() {
        val buttons = arrayOf<View>(squareButton, circleButton, heartButton, starButton, pixelButton)
    ...
    override fun setShapeActivated(shape: DrawableShape) {
        ...
        when (shape) {
            ...
            DrawableShape.PIXEL -> {
                pixelButton.isSelected = true
                setShapeToolDialogTitle(R.string.shape_tool_dialog_pixel_title)
            }
        }
    }
    ...
    private fun setupUI(
        ...
        pixelButton.setImageResource(pixelButtonResource)
        ...
        when (drawType) {
            DrawableStyle.FILL -> {
                ...
                setupUI(
                    ...
                    R.drawable.ic_pocketpaint_pixel,
                    View.GONE
                )
            }
            DrawableStyle.STROKE -> {
                ...
                setupUI(
                    ...
                    R.drawable.ic_pocketpaint_pixel_out,
                    View.VISIBLE
                )
            }
        }
