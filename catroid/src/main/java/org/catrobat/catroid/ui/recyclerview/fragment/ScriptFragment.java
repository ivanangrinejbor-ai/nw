...
public class ScriptFragment extends ListFragment implements
	...
	public void onCategorySelected(String category) {
		...
		if (category != null && category.equals(getContext().getString(R.string.category_user_bricks))) {
		...
		} else if (currentFragment instanceof AddBrickFragment || (category != null && category.equals(getContext().getString(R.string.category_search_bricks)))) {
