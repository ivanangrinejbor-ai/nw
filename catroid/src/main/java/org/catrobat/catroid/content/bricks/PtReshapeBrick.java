...
public class PtReshapeBrick extends FormulaBrick {
    ...
    public PtReshapeBrick(String tensorName, String newShape) {
        this(new Formula(tensorName), new Formula(newShape));
    }

    public PtReshapeBrick(Formula tensorName, Formula newShape) {
        this();
        setFormulaWithBrickField(BrickField.NAME, tensorName);
        setFormulaWithBrickField(BrickField.VALUE_1, newShape);
    }
