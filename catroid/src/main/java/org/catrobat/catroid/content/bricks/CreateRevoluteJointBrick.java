...
public class CreateRevoluteJointBrick extends FormulaBrick {
    private static final long serialVersionUID = 1L;

    public CreateRevoluteJointBrick() {
    ...
    public CreateRevoluteJointBrick(String jointId, String spriteBName, int anchorX, int anchorY) {
        this(new Formula(jointId), new Formula(spriteBName), new Formula(anchorX), new Formula(anchorY));
    }

    public CreateRevoluteJointBrick(Formula jointId, Formula spriteB, Formula anchorX, Formula anchorY) {
        this();
    ...
    public int getViewResource() {
        return R.layout.brick_create_revolute_joint;
    }

    @Override
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction((sprite.getActionFactory())
                .createRevoluteJointAction(sprite, sequence,
