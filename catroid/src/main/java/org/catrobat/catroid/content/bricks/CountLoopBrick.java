...
public class CountLoopBrick extends FormulaBrick implements CompositeBrick {
	...
	public CountLoopBrick(Formula times) {
		this();
	...
	public void setLoopVariable(UserVariable loopVariable) {
		this.loopVariable = loopVariable;
	}

	public UserVariable getLoopVariable() {
		return loopVariable;
	}
	...
	public Brick clone() throws CloneNotSupportedException {
		CountLoopBrick clone = (CountLoopBrick) super.clone();
	...
	public int getViewResource() {
		return R.layout.brick_count_loop;
	}
