...
public class StackPopBrick extends UserVariableBrickWithFormula {
	...
	public StackPopBrick() {
	}

	public StackPopBrick(UserVariable userVariable, UserVariable destVariable) {
	...
	public int getViewResource() {
		return R.layout.brick_stack_pop;
	}

	@Override
	protected int getSpinnerId() {
		return R.id.brick_stack_pop_spinner;
	}
	...
	public View getView(Context context) {
		...
		destSpinner = new BrickSpinner<>(R.id.brick_stack_pop_dest_spinner, view, items);
	...
	public void onItemSelected(Integer spinnerId, @Nullable UserVariable item) {
		if (spinnerId == R.id.brick_stack_pop_dest_spinner) {
			destVariable = item;
		} else {
	...
	public Brick clone() throws CloneNotSupportedException {
		StackPopBrick clone = (StackPopBrick) super.clone();
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createStackPopAction(sprite, sequence,
