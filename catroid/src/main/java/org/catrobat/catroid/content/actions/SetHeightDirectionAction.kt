...
class SetHeightDirectionAction : TemporalAction() {
    companion object {
    ...
    override fun update(percent: Float) {
        ...
        try {
            val targetPercent = size?.interpretFloat(currentScope) ?: 100f
            val look = currentScope.sprite.look ?: return
            val newScaleY = targetPercent / 100f
            val deltaScale = newScaleY - look.scaleY
