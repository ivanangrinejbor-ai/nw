...
class SpeakWithRateAction : AsynchronousAction() {
    ...
    override fun initialize() {
        ...
        val scope = speechSynthesizer.scope
        speechSynthesizer.rate = rate?.interpretObject(scope)?.toString()
        speechSynthesizer.pitch = pitch?.interpretObject(scope)?.toString()
