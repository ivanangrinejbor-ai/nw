...
public class WhenFirebaseChildChangedEventId extends EventId {
	final Formula bucket;
	final Formula path;
	final int eventType;

	public WhenFirebaseChildChangedEventId(Formula bucket, Formula path, int eventType) {
		this.bucket = bucket;
		this.path = path;
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof WhenFirebaseChildChangedEventId)) {
			return false;
		}
		if (!super.equals(o)) {
			return false;
		...
		WhenFirebaseChildChangedEventId that = (WhenFirebaseChildChangedEventId) o;
		...
		return thisBucket.equals(thatBucket) && thisPath.equals(thatPath) && eventType == that.eventType;
	}
