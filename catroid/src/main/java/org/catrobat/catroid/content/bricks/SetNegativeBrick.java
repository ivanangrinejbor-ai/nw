...
public class SetNegativeBrick extends FormulaBrick {
    ...
    public SetNegativeBrick(Formula formula, Formula formula2) {
        this();
    ...
    public int getViewResource() {
        return R.layout.brick_set_negative;
    }

    @Override
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory()
                .createNegativeAction(sprite, sequence,
