...
public class ShowVarFontBrick extends UserVariableBrickWithVisualPlacement {
    ...
    public ShowVarFontBrick() {
        addAllowedBrickField(BrickField.X_POSITION, R.id.brick_show_var_font_edit_text_x);
        addAllowedBrickField(BrickField.Y_POSITION, R.id.brick_show_var_font_edit_text_y);
        addAllowedBrickField(BrickField.SIZE, R.id.brick_show_var_font_edit_relative_size);
        addAllowedBrickField(BrickField.COLOR, R.id.brick_show_var_font_edit_color);
        addAllowedBrickField(BrickField.FILE, R.id.brick_show_var_font_edit_font);

        showFormulaEditorStrategy = new ShowColorPickerFormulaEditorStrategy();
    }

    public ShowVarFontBrick(int xPosition, int yPosition, double size, String color, String file) {
        this(new Formula(xPosition), new Formula(yPosition), new Formula(size), new Formula(color), new Formula(file));
    }

    private ShowVarFontBrick(Formula xPosition, Formula yPosition, Formula size, Formula color, Formula file) {
        this();
    ...
    public void showFormulaEditorToEditFormula(View view) {
        if (view.getId() == R.id.brick_show_var_font_edit_color && isValidColorString(getColor())) {
    ...
    public int getViewResource() {
        return R.layout.brick_show_var_font;
    }
    ...
    public View getView(Context context) {
        ...
        BrickSpinner<AlignmentStyle> spinner =
                new BrickSpinner<>(R.id.brick_show_var_font_align_spinner, view, items);
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        ...
        sequence.addAction(sprite.getActionFactory().createShowVarFontAction(sprite,
                sequence, getFormulaWithBrickField(BrickField.FILE),
    ...
    public int getXEditTextId() {
        return R.id.brick_show_var_font_edit_text_x;
    }

    @Override
    public int getYEditTextId() {
        return R.id.brick_show_var_font_edit_text_y;
    }
