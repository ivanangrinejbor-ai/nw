...
public class SortListBrick extends FormulaBrick implements BrickSpinner.OnItemSelectedListener<UserList> {
    ...
    public SortListBrick() {
    }

    @Override
    public int getViewResource() {
        return R.layout.brick_sort_list;
    }
    ...
    public View getView(Context context) {
        ...
        listSpinner = new BrickSpinner<>(R.id.sort_list_spinner, view, listItems);
        listSpinner.setOnItemSelectedListener(this);
        listSpinner.setSelection(userList);

        Spinner orderSpinner = view.findViewById(R.id.sort_order_spinner);
        String[] orders = {context.getString(R.string.sort_ascending), context.getString(R.string.sort_descending)};
        orderSpinner.setAdapter(new ArrayAdapter<>(context, android.R.layout.simple_spinner_item, orders));
        orderSpinner.setSelection(ascending ? 0 : 1);
        orderSpinner.setOnItemSelectedListener(new AdapterViewOnItemSelectedListenerImpl(position -> {
            ascending = position == 0;
    ...
    public void onNewOptionSelected(Integer spinnerId) {
        ...
        userListDialog.show(activity.getString(R.string.data_label), activity.getString(R.string.ok), new AddUserListDialog.Callback() {
            ...
            public void onPositiveButton(DialogInterface dialog, String textInput) {
                ...
                listSpinner.setSelection(userList);
                SortListBrick.this.userList = userList;
            ...
            public void onNegativeButton() {
                listSpinner.setSelection(SortListBrick.this.userList);
            }
        });
    }
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory().createSortListAction(userList, ascending));
    }
}
