...
public class SetLookFilesBrick extends FormulaBrick {
    ...
    public SetLookFilesBrick(Formula formula) {
        this();
    ...
    public int getViewResource() {
        return R.layout.brick_set_look_files;
    }

    @Override
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory()
                .createSetLookFilesAction(sprite, sequence,
