...
public class RepeatWhileBrick extends FormulaBrick implements CompositeBrick {

	private static final long serialVersionUID = 1L;
	private transient EndBrick endBrick = new EndBrick(this);
	private List<Brick> loopBricks = new ArrayList<>();

	public RepeatWhileBrick() {
		addAllowedBrickField(BrickField.REPEAT_UNTIL_CONDITION, R.id.brick_repeat_while_edit_text);
	}

	public RepeatWhileBrick(Formula condition) {
		this();
	...
	public Brick clone() throws CloneNotSupportedException {
		RepeatWhileBrick clone = (RepeatWhileBrick) super.clone();
	...
	public int getViewResource() {
		return R.layout.brick_repeat_while;
	}
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		...
		Action action = sprite.getActionFactory()
				.createRepeatWhileAction(sprite, sequence,
