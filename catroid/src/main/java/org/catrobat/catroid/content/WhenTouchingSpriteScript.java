...
public class WhenTouchingSpriteScript extends Script {

	private static final long serialVersionUID = 1L;

	private boolean reactToBackground = false;

	public WhenTouchingSpriteScript() {
	}

	public WhenTouchingSpriteScript(boolean reactToBackground) {
	...
	public Script clone() throws CloneNotSupportedException {
		WhenTouchingSpriteScript clone = (WhenTouchingSpriteScript) super.clone();
	...
	public ScriptBrick getScriptBrick() {
		if (scriptBrick == null) {
			scriptBrick = new WhenTouchingSpriteBrick(this);
		}
		return scriptBrick;
	}
	...
	public EventId createEventId(Sprite sprite) {
		return new TouchingSpriteEventId(sprite, "");
	}
}
