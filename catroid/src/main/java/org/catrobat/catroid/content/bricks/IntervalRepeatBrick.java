...
public class IntervalRepeatBrick extends FormulaBrick implements CompositeBrick {
    ...
    public IntervalRepeatBrick(Formula times, Formula interval) {
        this();
        setFormulaWithBrickField(BrickField.TIMES_TO_REPEAT, times);
        setFormulaWithBrickField(BrickField.INTERVAL, interval);
    }
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        ...
        Action action = sprite.getActionFactory().createIntervalRepeatAction(sprite, sequence,
                getFormulaWithBrickField(BrickField.TIMES_TO_REPEAT),
                getFormulaWithBrickField(BrickField.INTERVAL),
                loopSequence);
    ...
    @Override public Brick clone() throws CloneNotSupportedException {
        IntervalRepeatBrick clone = (IntervalRepeatBrick) super.clone();
