...
class Create3dJoystickAction : Action() {
    ...
    private fun runAsyncCreate() {
        ...
        val spd = speed?.interpretFloat(scope) ?: 0.5f
        ...
        stage.runOnUiThread {
            try {
                ...
                stage.addViewToStage("joystick_3d_" + sprite.name, container, params)
            } finally {
                finished = true
            }
        }
    ...
    private fun setDefaultBg(view: ImageView) {
        view.background = GradientDrawable().apply {
            ...
            setStroke(4, Color.parseColor("#8838BDF8"))
        }
    }
    ...
    private fun setDefaultThumb(view: ImageView) {
        view.background = GradientDrawable().apply {
            shape = GradientDrawable.OVAL
            setColor(Color.parseColor("#CCF59E0B"))
        }
    }
