...
@XStreamAlias("RunAsSpriteBrick")
public class RunAsSpriteBrick extends FormulaBrick implements CompositeBrick {
    ...
    public RunAsSpriteBrick(Formula spriteName) {
        this();
        setFormulaWithBrickField(BrickField.NAME, spriteName);
    }
    ...
    public Brick clone() throws CloneNotSupportedException {
        RunAsSpriteBrick clone = (RunAsSpriteBrick) super.clone();
    ...
    public int getViewResource() {
        return R.layout.brick_run_as_sprite;
    }
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        Action action = sprite.getActionFactory().createRunAsSpriteAction(
                sprite,
                sequence,
                sequence.getScript(),
