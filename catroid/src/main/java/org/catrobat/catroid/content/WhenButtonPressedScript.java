...
public class WhenButtonPressedScript extends Script {
	...
	public WhenButtonPressedScript() {
	}

	public WhenButtonPressedScript(int keyCode) {
	...
	public ScriptBrick getScriptBrick() {
		if (scriptBrick == null) {
			scriptBrick = new WhenButtonPressedBrick(this);
		}
		return scriptBrick;
	}
	...
	public EventId createEventId(Sprite sprite) {
		return new VolumeButtonEventId(keyCode);
	}
}