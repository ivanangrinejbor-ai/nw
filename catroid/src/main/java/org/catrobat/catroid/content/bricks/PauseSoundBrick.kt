...
class PauseSoundBrick : BrickBaseType(),
    ...
    override fun getViewResource() = R.layout.brick_pause_sound
    ...
    override fun getView(context: Context): View {
        ...
        spinner = BrickSpinner(R.id.brick_pause_sound_spinner, view, items)
    ...
    override fun onNewOptionSelected(spinnerId: Int) {
        (UiUtils.getActivityFromView(view) as? SpriteActivity)?.apply {
            registerOnNewSoundListener(this@PauseSoundBrick)
    ...
    override fun addActionToSequence(sprite: Sprite, sequence: ScriptSequenceAction) {
        sequence.addAction(sprite.actionFactory.createPauseSoundAction(sprite, sound))
    }
}
