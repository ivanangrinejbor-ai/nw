...
public class AverageOfListBrick extends FormulaBrick implements BrickSpinner.OnItemSelectedListener<UserList> {
    ...
    public AverageOfListBrick() {
    }

    @Override
    public int getViewResource() {
        return R.layout.brick_average_of_list;
    }
    ...
    public View getView(Context context) {
        ...
        listSpinner = new BrickSpinner<>(R.id.avg_list_spinner, view, listItems);
        ...
        varSpinner = new BrickSpinner<>(R.id.avg_var_spinner, view, varItems);
    ...
    private void showNewListDialog() {
        ...
        userListDialog.show(activity.getString(R.string.data_label), activity.getString(R.string.ok), new AddUserListDialog.Callback() {
            ...
            public void onPositiveButton(DialogInterface dialog, String textInput) {
                ...
                listSpinner.setSelection(userList);
                AverageOfListBrick.this.userList = userList;
            ...
            public void onNegativeButton() {
                listSpinner.setSelection(AverageOfListBrick.this.userList);
            }
        });
    }
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory().createAverageOfListAction(userList, resultVariable));
    }
}
