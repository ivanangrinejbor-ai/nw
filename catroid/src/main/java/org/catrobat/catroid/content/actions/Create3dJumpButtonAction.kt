...
class Create3dJumpButtonAction : Action() {
    ...
    private fun runAsyncCreate() {
        ...
        val pwr = jumpPower?.interpretFloat(scope) ?: 2f
            ...
            try {
                ...
                fun setInactiveState() {
                    if (inactiveBmp != null) {
                        ...
                        buttonView.background = GradientDrawable().apply {
                            ...
                            setColor(Color.parseColor("#66F59E0B"))
                            setStroke(3, Color.parseColor("#AAF59E0B"))
                        }
                    }
                }
                ...
                fun setActiveState() {
                    if (activeBmp != null) {
                        ...
                        buttonView.background = GradientDrawable().apply {
                            shape = GradientDrawable.OVAL
                            setColor(Color.parseColor("#FFF59E0B"))
                ...
                stage.addViewToStage("jump_3d_" + sprite.name, buttonView, params)
            } finally {
                finished = true
            }
        }
