...
public class SetHitboxBrick extends BrickBaseType implements BrickSpinner.OnItemSelectedListener<LookData>,
    ...
    public Brick clone() throws CloneNotSupportedException {
        SetHitboxBrick clone = (SetHitboxBrick) super.clone();
        clone.spinner = null;
        return clone;
    }
    ...
    public int getViewResource() {
        return R.layout.brick_set_hitbox;
    }
    ...
    public View getView(Context context) {
        ...
        spinner = new BrickSpinner<>(R.id.brick_set_hitbox_spinner, view, items);
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory().createSetHitboxAction(sprite, sequence, look));
    }
