...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField implements FormulaField {
		...
		FLOAT_ARRAY, VERTEX, FRAGMENT, X1, X2, Y1, Y2,
		OK, CANEL, DEFAULT, FIREBASE_ID, FIREBASE_KEY, FIREBASE_VALUE, TEST_FORMULA,
		RED, GREEN, BLUE, ALPHA, REGEX, TITLE, MESSAGE, MODEL, ROTATION, BORDERS, HIDE_STATUS_BAR,
