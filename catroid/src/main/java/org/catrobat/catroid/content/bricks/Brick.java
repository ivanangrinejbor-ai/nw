...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField implements FormulaField {
		...
		OK, CANEL, DEFAULT, FIREBASE_ID, FIREBASE_KEY, FIREBASE_VALUE, TEST_FORMULA, VALUE_2, VALUE_3, VALUE_4, VALUE_5, VALUE_1, VALUE_6, VALUE_7,
		...
		ASSERT_LOOP_ACTUAL, THREED_OBJECT_ID, THREED_ENABLED, THREED_VERTEX_SHADER_CODE, THREED_FRAGMENT_SHADER_CODE, THREED_UNIFORM_NAME, VALUE_X, VALUE_Y, VALUE_Z, SCRIPT, FILE_NAME, VARIABLE_NAME, GL_VIEW_NAME, VM_DISK_SIZE, VM_DISK_NAME, VM_HDA, VM_CDROM, VM_CPU, VM_MEMORY, VM_KEY_DOWN;
