...
public class WhenFirebaseChildChangedScript extends Script {

	private static final long serialVersionUID = 1L;

	private ConcurrentFormulaHashMap formulaMap = new ConcurrentFormulaHashMap();
	private int eventTypeSelection = 0;

	public WhenFirebaseChildChangedScript() {
	...
	public void setEventTypeSelection(int eventTypeSelection) {
		this.eventTypeSelection = eventTypeSelection;
	}

	@Override
	public Script clone() throws CloneNotSupportedException {
		WhenFirebaseChildChangedScript clone = (WhenFirebaseChildChangedScript) super.clone();
	...
	public ScriptBrick getScriptBrick() {
		if (scriptBrick == null) {
			scriptBrick = new WhenFirebaseChildChangedBrick(this);
		}
		return scriptBrick;
	}
	...
	public EventId createEventId(Sprite sprite) {
		WhenFirebaseChildChangedBrick brick = (WhenFirebaseChildChangedBrick) getScriptBrick();
		return new WhenFirebaseChildChangedEventId(
