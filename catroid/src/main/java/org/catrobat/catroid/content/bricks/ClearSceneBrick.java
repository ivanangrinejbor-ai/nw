...
import org.catrobat.catroid.content.actions.ClearSceneAction;
...
public class ClearSceneBrick extends BrickBaseType implements BrickSpinner.OnItemSelectedListener<Scene> {
    ...
    public ClearSceneBrick() {
        sceneToStart = "";
    }

    public ClearSceneBrick(String sceneToStart) {
    ...
    public Brick clone() throws CloneNotSupportedException {
        ClearSceneBrick clone = (ClearSceneBrick) super.clone();
        clone.spinner = null;
        return clone;
    }
    ...
    public int getViewResource() {
        return R.layout.brick_clear_scene;
    }
    ...
    public View getView(final Context context) {
        ...
        spinner = new BrickSpinner<>(R.id.brick_clear_scene_spinner, view, items);
    ...
    public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
        sequence.addAction(sprite.getActionFactory().createClearSceneAction(sceneToStart, sprite));
    }
}
