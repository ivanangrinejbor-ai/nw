...
public class ShowText2Action extends TemporalAction {

    public static final String TAG = ShowText2Action.class.getSimpleName();
    ...
    protected void begin() {
        try {
            ...
            String actorName = this.name.interpretString(scope);
            ...
            if (StageActivity.stageListener != null) {
                ...
                for (Actor actor : stageActors) {
                    if (actor.getClass().equals(dummyActor.getClass())) {
                        ...
                        if (showTextActor.getVariableNameToCompare().equals(actorName)
    ...
    public void setName(Formula nameg) {
        this.name = nameg;
    }

    public void setText(Formula textg) {
        this.text = textg;
    }
