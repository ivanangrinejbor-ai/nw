...
public class SlideInBrick extends FormulaBrick {
	...
	public SlideInBrick() {
		addAllowedBrickField(BrickField.SPEED, R.id.brick_slide_in_edit_text);
	}

	public SlideInBrick(double speed) {
		this(new Formula(speed));
	}

	public SlideInBrick(Formula formula) {
		this();
	...
	public int getViewResource() {
		return R.layout.brick_slide_in;
	}
	...
	public View getView(Context context) {
		...
		Spinner spinner = view.findViewById(R.id.brick_slide_in_spinner);
	...
	public void addActionToSequence(Sprite sprite, ScriptSequenceAction sequence) {
		sequence.addAction(sprite.getActionFactory().createSlideInAction(sprite, sequence,
