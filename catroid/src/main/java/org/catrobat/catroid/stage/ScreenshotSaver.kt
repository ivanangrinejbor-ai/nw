...
class ScreenshotSaver(
    ...
    companion object {
        ...
        private const val NEW_MAX_SCREEN_SHOT_HEIGHT = 3000
        private const val NEW_MAX_SCREEN_SHOT_WIDTH = 3000
    ...
    fun getScreenshot(data: ByteArray): InputStream {
        ...
        if (colors.size != width * height || colors.isEmpty()) {
            throw IllegalArgumentException("Invalid data for screenshot")
        }
