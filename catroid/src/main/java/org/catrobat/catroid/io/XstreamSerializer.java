...
import org.catrobat.catroid.content.scripts.AdmobInterstitialClosedScript;
...
import org.catrobat.catroid.content.scripts.AdmobInterstitialShownScript;
...
public final class XstreamSerializer {
	...
	private void prepareXstream(Class projectClass, Class sceneClass) {
		...
		xstream.processAnnotations(org.catrobat.catroid.content.FloatingBrick.class);
		...
		xstream.alias("whenFirebaseChildChangedScript", WhenFirebaseChildChangedScript.class);
		...
		xstream.alias("script", WhenNotificationActionClickedScript.class);
		xstream.alias("script", WhenNotificationReplyScript.class);
		xstream.alias("script", WhenNotificationShownScript.class);
		xstream.alias("script", WhenNotificationDismissedScript.class);

		xstream.alias("brick", AddItemToUserListBrick.class);
		xstream.alias("brick", PostWebRequestBrick.class);
		xstream.alias("brick", PutWebRequestBrick.class);
		xstream.alias("brick", PatchWebRequestBrick.class);
		xstream.alias("brick", DeleteWebRequestBrick.class);
		xstream.alias("brick", HeadWebRequestBrick.class);
		xstream.alias("brick", OptionsWebRequestBrick.class);
		...
		xstream.alias("brick", FirebaseSignInAnonymouslyBrick.class);
		xstream.alias("brick", FirebaseSignInEmailPasswordBrick.class);
		xstream.alias("brick", FirebaseSignOutBrick.class);
		xstream.alias("brick", FirebaseGetUserIdBrick.class);
		xstream.alias("brick", FirebaseIsSignedInBrick.class);
		xstream.alias("brick", PushBaseBrick.class);
		xstream.alias("brick", UpdateBaseBrick.class);
		xstream.alias("brick", QueryBaseBrick.class);
		xstream.alias("brick", WhenFirebaseChildChangedBrick.class);
		xstream.alias("brick", WriteFirestoreBrick.class);
		xstream.alias("brick", UpdateFirestoreBrick.class);
		xstream.alias("brick", AddFirestoreDocumentBrick.class);
		xstream.alias("brick", ReadFirestoreBrick.class);
		xstream.alias("brick", DeleteFirestoreBrick.class);
		xstream.alias("brick", QueryFirestoreBrick.class);
		xstream.alias("whenFirestoreChangedScript", WhenFirestoreChangedScript.class);
        ...
        xstream.alias("brick", AdmobInitializeBrick.class);
        xstream.alias("brick", AdmobSetBannerUnitIdBrick.class);
        xstream.alias("brick", AdmobLoadBannerBrick.class);
        xstream.alias("brick", AdmobShowBannerBrick.class);
        xstream.alias("brick", AdmobHideBannerBrick.class);
        xstream.alias("brick", AdmobDestroyBannerBrick.class);
        xstream.alias("brick", AdmobSetInterstitialUnitIdBrick.class);
        xstream.alias("brick", AdmobLoadInterstitialBrick.class);
        xstream.alias("brick", AdmobShowInterstitialBrick.class);
        xstream.alias("brick", AdmobSetRewardedUnitIdBrick.class);
        xstream.alias("brick", AdmobLoadRewardedBrick.class);
        xstream.alias("brick", AdmobShowRewardedBrick.class);
        xstream.alias("brick", AdmobSetAppOpenUnitIdBrick.class);
        xstream.alias("brick", AdmobLoadAppOpenBrick.class);
        xstream.alias("brick", AdmobShowAppOpenBrick.class);
        xstream.alias("brick", AdmobInitializedEventBrick.class);
        xstream.alias("brick", AdmobInitFailedEventBrick.class);
        xstream.alias("brick", AdmobBannerLoadedEventBrick.class);
        xstream.alias("brick", AdmobBannerFailedEventBrick.class);
        xstream.alias("brick", AdmobBannerShownEventBrick.class);
        xstream.alias("brick", AdmobBannerHiddenEventBrick.class);
        xstream.alias("brick", AdmobInterstitialLoadedEventBrick.class);
        xstream.alias("brick", AdmobInterstitialFailedEventBrick.class);
        xstream.alias("brick", AdmobInterstitialShownEventBrick.class);
        xstream.alias("brick", AdmobInterstitialClosedEventBrick.class);
        xstream.alias("brick", AdmobRewardedLoadedEventBrick.class);
        xstream.alias("brick", AdmobRewardedFailedEventBrick.class);
        xstream.alias("brick", AdmobRewardedShownEventBrick.class);
        ...
        xstream.alias("script", AdmobInitializedScript.class);
        xstream.alias("script", AdmobInitFailedScript.class);
        xstream.alias("script", AdmobBannerLoadedScript.class);
        xstream.alias("script", AdmobBannerFailedScript.class);
        xstream.alias("script", AdmobBannerShownScript.class);
        xstream.alias("script", AdmobBannerHiddenScript.class);
        xstream.alias("script", AdmobInterstitialLoadedScript.class);
        xstream.alias("script", AdmobInterstitialFailedScript.class);
        xstream.alias("script", AdmobInterstitialShownScript.class);
        xstream.alias("script", AdmobInterstitialClosedScript.class);
        xstream.alias("script", AdmobRewardedLoadedScript.class);
        xstream.alias("script", AdmobRewardedFailedScript.class);
        xstream.alias("script", AdmobRewardedShownScript.class);
