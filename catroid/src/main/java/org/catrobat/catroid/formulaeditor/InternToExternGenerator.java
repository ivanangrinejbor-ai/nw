...
public class InternToExternGenerator {
	...
	static {
		...
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.GET_ITEM.name(), R.string.formula_editor_function_get_item);
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_IS_TOUCHED.name(), R.string.formula_f2d_is_touched);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_IS_TOUCHED_INDEX.name(), R.string.formula_f2d_is_touched_index);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_X.name(), R.string.formula_f2d_x);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_Y.name(), R.string.formula_f2d_y);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_ROTATION.name(), R.string.formula_f2d_rotation);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_SCALE_X.name(), R.string.formula_f2d_scale_x);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_SCALE_Y.name(), R.string.formula_f2d_scale_y);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_COLOR_R.name(), R.string.formula_f2d_r);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_COLOR_G.name(), R.string.formula_f2d_g);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_COLOR_B.name(), R.string.formula_f2d_b);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_ALPHA.name(), R.string.formula_f2d_alpha);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.F2D_TEXTURE.name(), R.string.formula_f2d_texture);
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.API_LEVEL.name(), R.string.formula_api_level);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SYSTEM_LANGUAGE.name(), R.string.formula_system_language);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SYSTEM_THEME.name(), R.string.formula_system_theme);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.CPU_NAME.name(), R.string.formula_cpu_name);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.CPU_ARCHITECTURE.name(), R.string.formula_cpu_architecture);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.CPU_CORES.name(), R.string.formula_cpu_cores);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.CPU_FREQUENCY.name(), R.string.formula_cpu_frequency);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.TOTAL_RAM.name(), R.string.formula_total_ram);
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.BATTERY_VOLTAGE.name(), R.string.formula_battery_voltage);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.BATTERY_STATE.name(), R.string.formula_battery_state);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.INTERNET_CONNECTED.name(), R.string.formula_internet_connected);
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SCREEN_REFRESH.name(), R.string.formula_screen_refresh);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SCREEN_ORIENTATION.name(), R.string.formula_screen_orientation);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_EXISTS.name(), R.string.formula_sprite_exists);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_X.name(), R.string.formula_sprite_x);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_Y.name(), R.string.formula_sprite_y);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_SIZE.name(), R.string.formula_sprite_size);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_WIDTH.name(), R.string.formula_sprite_width);
        ...
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_INDEX_GET.name(), R.string.formula_sprite_index_get);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_UUID.name(), R.string.formula_sprite_uuid);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_CLONE_COUNT.name(), R.string.formula_sprite_clone_count);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_LOOK_COUNT.name(), R.string.formula_sprite_look_count);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_SOUND_COUNT.name(), R.string.formula_sprite_sound_count);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_VARIABLE_COUNT.name(), R.string.formula_sprite_variable_count);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_LIST_COUNT.name(), R.string.formula_sprite_list_count);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_DISTANCE.name(), R.string.formula_sprite_distance);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_TOUCHING.name(), R.string.formula_sprite_touching);
        INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.SPRITE_ANGLE_TO.name(), R.string.formula_sprite_angle_to);
