...
public enum Functions {
	...
	LUA, FLOATARRAY, VIEW_X, VIEW_Y, VIEW_WIDTH, VIEW_HEIGHT, VIDEO_PLAYING, VIDEO_TIME,
	ARDUINOANALOG,
	...
	public static EnumSet<Functions> TEXT = EnumSet.of(LENGTH, LETTER, SUBTEXT, CLAMP, TO_HEX, TO_DEC, DISTAN, UPPER, LOWER, REVERSE, VAR, VARNAME, VARVALUE, JOIN, JOIN3, REPLACE, CONTAINS_STR, REPEAT, RANDOM_STR, JOINNUMBER,
			...
			GET_3D_VELOCITY_X, GET_3D_VELOCITY_Y, GET_3D_VELOCITY_Z, GET_CAMERA_ROTATION_YAW, GET_CAMERA_ROTATION_PITCH, GET_CAMERA_ROTATION_ROLL, OBJECT_TOUCHES_OBJECT
			);
