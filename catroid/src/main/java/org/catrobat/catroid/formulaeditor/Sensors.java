...
public enum Sensors {
	...
	OBJECT_TRANSPARENCY(true), OBJECT_BRIGHTNESS(true), OBJECT_COLOR(true), OBJECT_SIZE(true), OBJECT_WIDTH(true), OBJECT_HEIGHT(true), WIDTH(true), HEIGHT(true),
	...
	OBJECT_LOOK_NUMBER(true), OBJECT_LOOK_WIDTH(true), OBJECT_LOOK_HEIGHT(true), OBJECT_LOOK_NAME(true), OBJECT_NUMBER_OF_LOOKS(true),
	OBJECT_BACKGROUND_NUMBER(true), OBJECT_BACKGROUND_NAME(true), OBJECT_NAME(true),
	...
	SPEECH_RECOGNITION_LANGUAGE, STAGE_WIDTH, STAGE_HEIGHT, MICRO, IP, PORT, FREQ, INTERNET, FPS, NFC_TECH_LIST, NFC_MEMORY_SIZE, NFC_IS_WRITABLE, NFC_TAG_TYPE,
	MOUSE_X, MOUSE_Y, MOUSE_DELTA_X, MOUSE_DELTA_Y, MOUSE_SCROLL,
	ARCH, BATTARY, CLIPBOARD_TEXT, KEYBOARD_HEIGHT,
	CURRENT_SCENE_NAME, SCENE_TIME, TOUCHING_SPRITE(true), TIMER_MS, SHAKE_INTENSITY;
	...
	public static final EnumSet<Sensors> BOOLEAN = EnumSet.of(
			...
			COLLIDES_WITH_FINGER, COLLIDES_WITH_EDGE, DRONE_RECORDING, DRONE_RECORD_READY, NFC_IS_WRITABLE);
