...
public enum Sensors {
	...
	SPEECH_RECOGNITION_LANGUAGE, STAGE_WIDTH, STAGE_HEIGHT, MICRO, IP, PORT, FREQ, INTERNET, BATTARY, ARCH, FPS, NFC_TECH_LIST, NFC_MEMORY_SIZE, NFC_IS_WRITABLE, NFC_TAG_TYPE,
