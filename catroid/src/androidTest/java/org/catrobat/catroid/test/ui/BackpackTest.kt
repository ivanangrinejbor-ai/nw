...
class BackpackTest {
    ...
    fun shouldPackAndUnpackScriptWithVariableAndListInOtherSprite() {
        ...
        val unpackedShowToastBlock = projectManager.currentSprite.scriptList[0].brickList[1]
            as ShowToastBlock
        val unpackedListenMicroBrick = projectManager.currentSprite.scriptList[0].brickList[1]
            as ListenMicroBrick
        val unpackedCopyTextBrick = projectManager.currentSprite.scriptList[0].brickList[1]
            as CopyTextBrick
        val unpackedPostWebRequestBrick = projectManager.currentSprite.scriptList[0].brickList[1]
            as PostWebRequestBrick
        assertEquals(1, projectManager.currentSprite.userVariables.size)
