...
public class XstreamSerializerTest {
	...
	public void testSerializeProject() throws Exception {
		...
		SetWidthBrick setWidthBrick = new SetWidthBrick(75);
		SetHeightBrick setHeightBrick = new SetHeightBrick(75);
		ChangeWidthBrick changeWidthBrick = new ChangeWidthBrick(75);
		ChangeHeightBrick changeHeightBrick = new ChangeHeightBrick(75);
