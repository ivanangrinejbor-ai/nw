...
public class BrickFormulaDefaultValueTest {
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
				...
				{"SetWidthBrick - R.id.brick_set_width_edit_text", "Looks", SetWidthBrick.class, R.id.brick_set_width_edit_text, "75 "},
				{"ChangeWidthBrick - R.id.brick_change_width_edit_text", "Looks", ChangeWidthBrick.class, R.id.brick_change_width_edit_text, "75 "},
				{"ChangeHeightBrick - R.id.brick_change_height_edit_text", "Looks", ChangeHeightBrick.class, R.id.brick_change_height_edit_text, "75 "},
				{"SetHeightBrick - R.id.brick_set_height_edit_text", "Looks", SetHeightBrick.class, R.id.brick_set_height_edit_text, "75 "},
				...
				{"PostWebRequestBrick - R.id.brick_post_web_request_edit_url", "Data",
						PostWebRequestBrick.class, R.id.brick_post_web_request_edit_url,
						"https://api.callfire.com/v2/texts?limit=50&offset=200 "},
				{"PostWebRequestBrick - R.id.brick_post_web_request_edit_url_edit_header", "Data",
						PostWebRequestBrick.class, R.id.brick_post_web_request_edit_header,
						"Content-Type:application/json "},
				{"PostWebRequestBrick - R.id.brick_post_web_request_edit_url_edit_body", "Data",
						PostWebRequestBrick.class, R.id.brick_post_web_request_edit_body,
						"{\nusername:password\n} "},
				{"SetGeminiKeyBrick - R.id.brick_set_geemini_key_edit_text", "Neural",
						SetGeminiKeyBrick.class, R.id.brick_set_gemini_key_edit_text,
						"api_key "},
				{"AskGeminiBrick - R.id.brick_ask_gemini_edit_url", "Neural",
						AskGeminiBrick.class, R.id.brick_ask_gemini_edit_url,
						"Hello! "},
				{"CreateVarBrick - R.id.brick_create_var_edit_text", "Data",
						CreateVarBrick.class, R.id.brick_create_var_edit_text,
						"variable1 "},
				{"CreateVarBrick - R.id.brick_create_var_edit_text2", "Data",
						CreateVarBrick.class, R.id.brick_create_var_edit_text2,
						"0 "},
				{"DeleteVarBrick - R.id.brick_delete_var_edit_text", "Data",
						DeleteVarBrick.class, R.id.brick_delete_var_edit_text,
						"variable1 "},
				{"ShowToastBlock - R.id.brick_show_toast_edit_text", "Device",
						ShowToastBlock.class, R.id.brick_show_toast_edit_text,
						"Hello World "},
				{"CreateTableBrick - R.id.brick_create_table_edit_name", "Data",
						CreateTableBrick.class, R.id.brick_create_table_edit_name,
						"myTable "},
				{"CreateTableBrick - R.id.brick_create_table_edit_x", "Data",
						CreateTableBrick.class, R.id.brick_create_table_edit_x,
						"5 "},
				{"CreateTableBrick - R.id.brick_create_table_edit_y", "Data",
						CreateTableBrick.class, R.id.brick_create_table_edit_y,
						"5 "},
				{"InsertTableBrick - R.id.brick_insert_table_edit_name", "Data",
						InsertTableBrick.class, R.id.brick_insert_table_edit_name,
						"myTable "},
				{"InsertTableBrick - R.id.brick_insert_table_edit_value", "Data",
						InsertTableBrick.class, R.id.brick_insert_table_edit_value,
						"1 "},
				{"InsertTableBrick - R.id.brick_insert_table_edit_x", "Data",
						InsertTableBrick.class, R.id.brick_insert_table_edit_x,
						"3 "},
				{"InsertTableBrick - R.id.brick_insert_table_edit_y", "Data",
						InsertTableBrick.class, R.id.brick_insert_table_edit_y,
						"2 "},
				{"DeleteTableBrick - R.id.brick_delete_table_edit_name", "Data",
						DeleteTableBrick.class, R.id.brick_delete_table_edit_name,
						"myTable "},
				{"SoundFileBrick - R.id.brick_sound_file_edit_text", "Sound",
						SoundFileBrick.class, R.id.brick_sound_file_edit_text,
						"my_sound.mp3 "},
				{"LookFileBrick - R.id.brick_look_file_edit_text", "Look",
						LookFileBrick.class, R.id.brick_look_file_edit_text,
						"my_actor.png "},
				{"SaveLookBrick - R.id.brick_save_look_edit_text", "Look",
						SaveLookBrick.class, R.id.brick_save_look_edit_text,
						"my_actor.png "},
				{"SceneIdBrick - R.id.brick_scene_id_edit_text", "Control",
						SceneIdBrick.class, R.id.brick_scene_id_edit_text,
						"0 "},
				{"FileUrlBrick - R.id.brick_file_url_edit_text", "Data",
						FileUrlBrick.class, R.id.brick_file_url_edit_text,
						"http://e95814zx.beget.tech/map.jpg "},
				{"FileUrlBrick - R.id.brick_file_url_edit_file", "Data",
						FileUrlBrick.class, R.id.brick_file_url_edit_file,
						"fileFromUrl.jpg"},
				{"StartServerBrick - R.id.brick_start_server_edit_text", "Internet",
						StartServerBrick.class, R.id.brick_start_server_edit_text,
						"1234 "},
				{"SendServerBrick - R.id.brick_send_server_edit_text", "Internet",
						SendServerBrick.class, R.id.brick_send_server_edit_text,
						"Hi "},
				{"ConnectServer - R.id.brick_connect_server_edit_port", "Internet",
						ConnectServerBrick.class, R.id.brick_connect_server_edit_port,
						"1234 "},
				{"ConnectServer - R.id.brick_connect_server_edit_ip", "Internet",
						ConnectServerBrick.class, R.id.brick_connect_server_edit_ip,
						"127.0.0.1 "},
				{"RunJSBrick - R.id.brick_run_js_edit_text", "Device",
						RunJSBrick.class, R.id.brick_run_js_edit_text,
						"1 + 2 "},
				{"CreateWebUrlBrick - R.id.create_web_file_name", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_name,
						"myWebView "},
				{"CreateWebUrlBrick - R.id.create_web_url_url", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_file,
						" "},
				{"CreateWebUrlBrick - R.id.create_web_url_x", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_x,
						"0"},
				{"CreateWebUrlBrick - R.id.create_web_url_y", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_y,
						"0"},
				{"CreateWebUrlBrick - R.id.create_web_url_width", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_width,
						"100"},
				{"CreateWebUrlBrick - R.id.create_web_url_height", "Device",
						CreateWebFileBrick.class, R.id.create_web_file_height,
						"200"},
				{"CreateWebUrlBrick - R.id.create_web_url_name", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_name,
						"myWebView "},
				{"CreateWebUrlBrick - R.id.create_web_url_url", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_url,
						"https://example.com "},
				{"CreateWebUrlBrick - R.id.create_web_url_x", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_x,
						"0"},
				{"CreateWebUrlBrick - R.id.create_web_url_y", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_y,
						"0"},
				{"CreateWebUrlBrick - R.id.create_web_url_width", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_width,
						"100"},
				{"CreateWebUrlBrick - R.id.create_web_url_height", "Device",
						CreateWebUrlBrick.class, R.id.create_web_url_height,
						"200"},
				{"CopyTextBrick - R.id.brick_copy_text_edit_text", "Device",
						CopyTextBrick.class, R.id.brick_copy_text_edit_text,
						"Котлета "},
				{"ListenMicroBrick - R.id.brick_listen_micro_edit_text", "Device",
						ListenMicroBrick.class, R.id.brick_listen_micro_edit_text,
						"100 "},
