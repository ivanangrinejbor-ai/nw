...
class FlattenListTest(
    ...
    companion object {
        ...
        private val functionConnect = context.getString(R.string.formula_editor_function_connect)
        private val functionFind = context.getString(R.string.formula_editor_function_find)
